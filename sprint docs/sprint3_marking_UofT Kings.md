...
## User Stories (Tracked in Jira) (max 10 marks) 
  - Correctly formulated user stories (max 2 marks)
    ...
    Your Mark: 1.5 UOF-109 does not have so that clause
  ...
  - Prioritized	(max 2 marks)
    ...
    Your Mark: 0 All but one story has same priority
  ...
  User Stories Total Mark: 7.5 / 10
...
## Tracking on Jira  (max 24 marks) 
  ...
  - Do the pull request on GitHub match the tasks listed on Jira Active Sprint Board? (max 2 marks)
    ...
    Your Mark: 1
    Several story/sub-tasks do not have corresponding pull request
...
## Sprint Completion (Max 20 marks) 
  ...
  Looks like you completed an extra task UOF-109
...
## Sprint Demo (Max 10 marks) 
    ...
    Working software (max 2 marks) Tuesday: 2 features Wednesday/Thursday: 3 features Friday: 4 features
...
Features
    ...
    Start to learn page
    Course page and course material
    modular learning (YouTube video, reading/text, deliverables)
